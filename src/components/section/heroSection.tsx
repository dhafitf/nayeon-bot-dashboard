    ...
    <div id="top" className="py-8 md:flex md:items-center md:py-16">
      <div className="relative mx-auto mt-11 mb-8 aspect-square w-full max-w-[314px]">
        <Image
          ...
          src="https://cdn.discordapp.com/avatars/939369011773321336/677d9e150f1521716a2188e14ceeca94.png?size=2048"
          layout="fill"
          alt="nayeon-bot"
          objectFit="cover"
      ...
      <div className="md:ml-8 mid:m-0 mid:max-w-md">
        ...
        <p className="pt-6 pb-8 text-lg max-md:text-center">Nayeon bot is a bot dedicated to notifying updates from TWICE, and also provides other commands.</p>
